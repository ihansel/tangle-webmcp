...
| Public source repository   | <https://github.com/ihansel/tangle-webmcp>     | **PENDING SOURCE PUSH** — the public repository exists; the reviewed commit must still be pushed and verified anonymously.                  |
...
| Upstream attribution       | `../UPSTREAM.md`                               | **VERIFIED** local file.                                                                                                                     |
| Demo video                 | `[PUBLIC YOUTUBE URL REQUIRED]`                | **BLOCKED** — script and production plan exist; recording/upload not authorized or completed.                                                |
