...
| `assets/gallery/01-home.png`                     | Tangle WebMCP commerce workspace and experiment catalogue.                  | Opening state and product story.              | 1800 × 1200 | 3:2   | 149,274 B   | Real hosted-app screenshot.                                                                  | PASS       |
